...
<div class="container mt-4">
    <table class="table table-striped" style="background: darkgray">
        ...
        <c:forEach var="x" items="${page.content}">
            <tr>
                ...
                <td>
                    <a href="/mausac/showadd?id=${x.id}" type="button" class="btn btn-success">ADD</a>
                    <a href="/mausac/detail?id=${x.id}" type="button" class="btn btn-primary">Detail</a>
                    <a href="/mausac/showupdate?id=${x.id}" type="button" class="btn btn-info">Edit</a>
                    <a href="/mausac/delete?id=${x.id}" type="button" class="btn btn-danger">Remove</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="d-flex justify-content-center">
        <a href="/mausac/list" class="btn btn-secondary mx-1"><<</a>
        <a href="/mausac/list?p=${page.first ? 0 : page.number - 1}" class="btn btn-secondary mx-1"><<|</a>
        <a href="/mausac/list?p=${page.last ? page.totalPages - 1 : page.number + 1}" class="btn btn-secondary mx-1">|>></a>
        <a href="/mausac/list?p=${page.totalPages - 1}" class="btn btn-secondary mx-1">>></a>
    </div>
