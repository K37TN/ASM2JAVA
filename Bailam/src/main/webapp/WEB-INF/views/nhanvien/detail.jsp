...
<form action="" method="post" class="container">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="id" value="${list.ma}" readonly>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="tendn" value="${list.tendn}" readonly>
    </div>

    <div class="mb-3">
        <label  class="form-label">Mật Khẩu</label>
        <input type="text" class="form-control" name="matKhau" value="${list.matKhau}" readonly>
    </div>

    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="true" ${list.trangThai == "Đang làm" ? "" : "checked"} disabled>
        <label class="form-check-label">
            Đang làm
        </label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="false" ${list.trangThai == "Đã nghỉ" ? "checked" : ""} disabled>
        <label class="form-check-label">
            Đã nghỉ
        </label>
    </div>

    <a href="/nhanvien/list" class="btn btn-primary">Quay Lại</a>
</form>
</body>