...
<div class="container mt-4">
    <table class="table table-striped" style="background: darkgray">
        ...
        <tr>
            <th scope="col">STT</th>
            <th scope="col">IDMS</th>
            <th scope="col">IDKT</th>
        ...
        <c:forEach var="x" items="${page.content}">
            <tr>
                ...
                <td>${x.soLuong}</td>
                <td>${x.donGia}</td>
                <td>${x.trangThai?"Hàng tồn":"Hàng mới"}</td>
                <td>
                    <a href="/sanphamct/showadd?id=${x.id}" type="button" class="btn btn-success">ADD</a>
                    <a href="/sanphamct/detail?id=${x.id}" type="button" class="btn btn-primary">Detail</a>
                    <a href="/sanphamct/showupdate?id=${x.id}" type="button" class="btn btn-info">Edit</a>
                    <a href="/sanphamct/delete?id=${x.id}" type="button" class="btn btn-danger">Remove</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="d-flex justify-content-center">
        <a href="/sanphamct/list" class="btn btn-secondary mx-1"><<</a>
        <a href="/sanphamct/list?p=${page.first ? 0 : page.number - 1}" class="btn btn-secondary mx-1"><<|</a>
        <a href="/sanphamct/list?p=${page.last ? page.totalPages - 1 : page.number + 1}" class="btn btn-secondary mx-1">|>></a>
        <a href="/sanphamct/list?p=${page.totalPages - 1}" class="btn btn-secondary mx-1">>></a>
    </div>
