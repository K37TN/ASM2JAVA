...
<div class="container mt-4">
    <table class="table table-striped" style="background: darkgray">
        ...
        <c:forEach var="x" items="${page.content}">
            <tr>
                ...
                <td>${x.idnv}</td>
                <td>${x.ngayMua}</td>
                <td>${x.trangThai?"Đã thanh toán":"Đang chờ"}</td>
                <td>
                    <a href="/hoadon/showadd?id=${x.id}" type="button" class="btn btn-success">ADD</a>
                    <a href="/hoadon/detail?id=${x.id}" type="button" class="btn btn-primary">Detail</a>
                    <a href="/hoadon/showupdate?id=${x.id}" type="button" class="btn btn-info">Edit</a>
                    <a href="/hoadon/delete?id=${x.id}" type="button" class="btn btn-danger">Remove</a>
                </td>
            </tr>
        </c:forEach>
        </tbody>
    ...
    <div class="d-flex justify-content-center">
        <a href="/hoadon/list" class="btn btn-secondary mx-1"><<</a>
        <a href="/hoadon/list?p=${page.first ? 0 : page.number - 1}" class="btn btn-secondary mx-1"><<|</a>
        <a href="/hoadon/list?p=${page.last ? page.totalPages - 1 : page.number + 1}" class="btn btn-secondary mx-1">|>></a>
        <a href="/hoadon/list?p=${page.totalPages - 1}" class="btn btn-secondary mx-1">>></a>
    </div>
