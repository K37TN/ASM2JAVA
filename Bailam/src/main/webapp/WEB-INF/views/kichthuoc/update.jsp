...
<form action="/kichthuoc/update" method="post" class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="ma" value="${list.ma}">
    </div>
    <div class="mb-3">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="true" ${list.trangThai == "Còn" ? "" : "checked"}>
        <label class="form-check-label">
            Còn
        </label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="false" ${list.trangThai == "Hết" ? "checked" : ""}>
        <label class="form-check-label">
            Hết
        </label>
    </div>
