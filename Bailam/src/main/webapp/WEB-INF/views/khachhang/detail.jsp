...
<form action="" method="post" class="container">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="sdt" value="${list.sdt}" readonly>
    </div>
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="true" ${list.trangThai == "Mới" ? "" : "checked"} disabled>
        <label class="form-check-label">
            Mới
        </label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="false" ${list.trangThai == "Cũ" ? "checked" : ""} disabled>
        <label class="form-check-label">
            Cũ
        </label>
    </div>

    <a href="/khachhang/list" class="btn btn-primary">Quay Lại</a>
</form>
</body>