...
<form action="/hoadon/update" method="post" class="container">
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="idkh" value="${list.idkh}" >
    </div>
    <div class="mb-3">
        <label  class="form-label">IDNV</label>
        <input type="text" class="form-control" name="idnv" value="${list.idnv}">
    </div>

    <div class="mb-3">
        <label  class="form-label">Ngày mua hàng</label>
        <input type="date" class="form-control" name="ngayMua" value="${list.ngayMua}">
    </div>
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="false" ${list.trangThai == " Đang chờ" ? "checked" : ""} >
        <label class="form-check-label">
            Đang chờ
        </label>
    </div>
