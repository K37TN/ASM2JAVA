...
<form action="/khachhang/update" method="post" class="container">
    <div class="mb-3">
    ...
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="true" ${list.trangThai == "Mới" ? "" : "checked"} >
        <label class="form-check-label">
            Mới
        </label>
    </div>
    <div class="form-check">
        <input class="form-check-input" type="radio" name="trangThai" value="false" ${list.trangThai == "Cũ" ? "checked" : ""} >
        <label class="form-check-label">
            Cũ
        </label>
    </div>
